...
from fivetran_connector_sdk import (
    Connector,
)  # Import the Connector class from the fivetran_connector_sdk module.
from fivetran_connector_sdk import (
    Logging as log,
)  # Import the Logging class from the fivetran_connector_sdk module, aliased as log.
from fivetran_connector_sdk import (
    Operations as op,
)  # Import the Operations class from the fivetran_connector_sdk module, aliased as op.
